...
client = OpenAI(
    ...
    api_key="sk-73ca16a84f75459f804ca9ea4fdb9624"  # 请替换为你的API密钥
)
...
examples_data = [
    ...
    {
        "content": "2024-05-16，股市利好。股票英伟达成美股今日开盘价105美元，一度飙升至109美元，随后回落至100美元，最终以116美元收盘，成交量达到3560000。",
        "answers": {
            "日期": "2024-05-16",
            "股票名称": "英伟达成美股",
            "开盘价": "105美元",
...
for q in questions:
    ...
    print(f"文本：{q}")
    print(f"抽取结果：{response.choices[0].message.content}")
    print("-" * 80)